...
if(!videoDetails?.snippet) return (<p className='text-danger text-center'>Loading...</p>)

const { snippet: {title,channelId,channelTitle}, statistics: {viewCount,likeCount} } = videoDetails;

  return (

      <div className='row justify-content-between' style={{height:{xs:'100%',md:'93vh'},width:'95%',margin:'auto'}} >

        <div className='col-xs-9 col-md-9 mt-3 mb-xs-4 '>
          ...
          <div>
            ...
            <div  className='d-flex justify-content-between align-items-center'>
              <p className='fw-bold m-0'> <Link to={`/channel/${channelId}`}> {channelTitle} <FontAwesomeIcon icon={faCheckCircle} /> </Link> </p>
              <div className='d-flex '> 
              <span className='me-4'>{parseInt(viewCount).toLocaleString()} views</span>
        ...
        <div className='col-xs-3 col-md-3 videosList' style={{height:'93vh',overflowY:'scroll'}}>
